...
export const adapters = [
  ...
  adapter("aa-tau3-banking", "tau3-banking", "tau3-banking", "https://artificialanalysis.ai/evaluations/tau3-banking"),
  adapter("aa-mmmu-pro", "mmmu-pro", "mmmu-pro", "https://artificialanalysis.ai/evaluations/mmmu-pro"),
  adapter("aa-ifbench", "ifbench", "ifbench", "https://artificialanalysis.ai/evaluations/ifbench"),
