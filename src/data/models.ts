import type { BenchmarkId, Model } from "./types";

/**
 * Curated static dataset for LLMcompare.
 * Prices: official primary-provider API rates ($/1M tokens) as of 2026-07-31.
 * Benchmarks: primary-provider system cards, model cards, or benchmark
 * leaderboards as of 2026-07-31. Agent scores are only retained when the
 * source setup is identifiable; mixed-harness or unverifiable values stay omitted.
 */
const rawModels: Model[] = [
  ...
  // ─── Anthropic ────────────────────────────────────────────
  {
    ...
    summary:
      "Anthropic's July 2026 flagship; public benchmark cells are intentionally empty until Anthropic publishes a primary scorecard.",
  },
  {
    slug: "claude-fable-5",
    name: "Claude Fable 5",
    ...
    summary:
      "Anthropic's general-availability Fable model for long-horizon coding and writing; premium pricing relative to Opus 5.",
  },
  {
  ...
  },
  {
    ...
    summary:
      "Default Claude model for Free/Pro; intro API pricing $2/$10 through Aug 31, 2026, then $3/$15. Closes much of the gap to prior Opus on agentic tasks.",
  },
  {
  ...
  // ─── Google ───────────────────────────────────────────────
  {
    ...
    links: {
      ...
      modelCard: "https://deepmind.google/models/model-cards/gemini-3-1-pro",
    },
    summary:
  ...
  },
  {
    ...
    summary:
      "Current Flash workhorse (Jul 21, 2026) at $1.50/$7.50 — successor to 3.5 Flash with lower output price and better token efficiency for agents.",
  },
  {
    slug: "gemini-3-flash",
    name: "Gemini 3 Flash",
    ...
    maxOutput: 65_536,
    modalities: { input: ["text", "image", "audio", "video"], output: ["text"] },
    pricing: { provider: "Google", inputPer1M: 0.5, outputPer1M: 3 },
    ...
    summary:
      "Gemini 3 Flash Preview (API id gemini-3-flash-preview) — cheaper Flash tier that still supports Computer Use; superseded for most agent/coding work by Gemini 3.5 Flash and 3.6 Flash.",
  },
  {
  ...
  },
  {
    ...
    openSource: true,
    license: "Apache 2.0",
    parameters: { total: 25.2, active: 3.8 },
    contextWindow: 256_000,
    maxOutput: 8192,
    modalities: { input: ["text", "image"], output: ["text"] },
  ...
  // ─── xAI ──────────────────────────────────────────────────
  {
    ...
    links: {
      docs: "https://docs.x.ai/developers/models/grok-4.5",
      announcement: "https://x.ai/news/grok-4-5",
    },
    summary:
      "xAI API flagship released in July 2026 at $2/$6, with 500K context and a primary-provider coding scorecard.",
  },
  {
    slug: "grok-4-3",
    name: "Grok 4.3",
...

  {
    ...
    summary:
      "Grok 4.20 reasoning model; current xAI documentation lists 1M context and $1.25/$2.50 short-context pricing.",
  },
  {
    slug: "grok-4-1",
    name: "Grok 4.1",
  ...
  // ─── Meta ─────────────────────────────────────────────────
  {
    ...
    links: {
      docs: "https://ai.meta.com/blog/introducing-muse-spark-meta-model-api/",
  ...
  },
  {
    ...
    summary:
      "Budget DeepSeek V4 API tier — the 2026-07-31 public-beta update (V4-Flash-0731) reports Terminal-Bench 2.1 82.7 and NL2Repo 54.2 using DeepSeek Harness minimal mode at max effort.",
  },
  {
    slug: "deepseek-v3-2",
    name: "DeepSeek V3.2",
  ...
  },
  {
    ...
    summary:
      "Alibaba Cloud Model Studio Max flagship (qwen3.7-max, 1M context) — international list $2.50/$7.50; limited-time 50% off brings effective rates to $1.25/$3.75.",
  },
  {
    slug: "qwen3-7-plus",
    name: "Qwen3.7 Plus",
    ...
    summary:
      "Alibaba's balanced Qwen3.7 SKU (1M context, tools, multimodality) — international list $0.40/$1.60 for prompts up to 256K, then $1.20/$4.80 through 1M context.",
  },
  {
    slug: "qwen3-5-397b",
  ...
  // ─── Mistral ──────────────────────────────────────────────
  {
    ...
    benchmarks: {},
    links: {
      docs: "https://docs.mistral.ai/models/model-cards/mistral-large-3-25-12",
      modelCard: "https://huggingface.co/mistralai",
      announcement: "https://mistral.ai/news/mistral-3/",
    },
    summary:
      "Mistral's open Large 3 MoE (675B/41B active, Apache 2.0) at $0.50/$1.50 — multilingual multimodal workhorse; Medium 3.5 is the stronger closed-ish frontier SKU.",
  },
  {
    ...
    parameters: { total: 128, active: 128 },
    contextWindow: 256_000,
    maxOutput: 64_000,
    modalities: { input: ["text", "image"], output: ["text"] },
    ...
    benchmarks: {},
    links: {
      docs: "https://docs.mistral.ai/models/model-cards/mistral-medium-3-5-26-04",
  ...
  },
  {
    ...
    openSource: true,
    license: "Apache 2.0",
    parameters: { total: 119, active: 6.5 },
    contextWindow: 256_000,
    maxOutput: 64_000,
    modalities: { input: ["text", "image"], output: ["text"] },
    ...
    benchmarks: {},
    links: {
      docs: "https://docs.mistral.ai/models/model-cards/mistral-small-4-0-26-03",
    },
    summary:
  ...
  },
  {
    ...
    benchmarks: {},
    links: {
      docs: "https://docs.mistral.ai/models/model-cards/devstral-2-25-12",
    },
    summary:
      "Historical open-weight agentic coding model; Mistral marked Devstral 2 deprecated on 2026-05-22 and recommends Medium 3.5.",
  },
  {
  ...
  },
  {
    ...
    summary:
      "Google I/O 2026 Flash GA (gemini-3.5-flash) at $1.50/$9 — prior Flash workhorse before Gemini 3.6 Flash cut output pricing to $7.50.",
  },
  {
    ...
    summary:
      "Historical Gemini 2.0 Flash entry; Google shut down the Gemini 2.0 API family on 2026-06-01.",
  },
  {
    ...
    summary:
      "Historical Gemini 2.0 Flash-Lite entry; Google shut down the Gemini 2.0 API family on 2026-06-01.",
  },
  {
    ...
    summary:
      "Historical Gemini 2.0 Flash Thinking entry; Google shut down the Gemini 2.0 API family on 2026-06-01.",
  },
  {
    slug: "gemini-1-0-pro",
    name: "Gemini 1.0 Pro",
...
/**
 * Public benchmark snapshot reviewed against primary sources on 2026-07-31.
 * Draft values in the raw catalog are deliberately not exposed unless they
 * appear here with a traceable benchmark/setup. Missing values render as —.
 */
const AUDITED_BENCHMARKS: Record<
  string,
  Partial<Record<BenchmarkId, number>>
> = {
  "gpt-5-6-sol": {
    "gpqa-diamond": 94.6,
    "swe-bench-pro": 64.6,
...
export const models: Model[] = rawModels.map((model) => ({
  ...model,
  benchmarks: AUDITED_BENCHMARKS[model.slug] ?? {},
}));
