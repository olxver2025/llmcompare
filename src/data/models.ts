...
export const models: Model[] = [
  ...
  // ─── Inception Labs ───────────────────────────────────────
  {
    ...
    maxOutput: 65_536,
    modalities: { input: ["text"], output: ["text"] },
    pricing: { provider: "Inception Labs", inputPer1M: 0.2, outputPer1M: 0.75 },
    benchmarks: {},
    links: {
      docs: "https://docs.inceptionlabs.ai/",
      announcement: "https://www.inceptionlabs.ai/models",
    },
    summary:
      "Preview of Inception's next diffusion LLM (dLLM), which refines tokens in parallel rather than autoregressively; Inception reports a 10+ point internal quality jump over Mercury 2 and throughput around 1,100 tokens/sec. No independent benchmark results are published yet.",
  },
  // ─── Apodex ───────────────────────────────────────────────
  {
    slug: "apodex-1-1",
    ...
    openSource: false,
    license: "Proprietary",
    parameters: { total: 397 },
    contextWindow: 262_144,
    maxOutput: 32_768,
    modalities: { input: ["text"], output: ["text"] },
    pricing: { provider: "Apodex", inputPer1M: 0.3, outputPer1M: 3 },
    benchmarks: {
      "gpqa-diamond": 86.4,
      hle: 34.1,
      scicode: 45.5,
      "terminal-bench-2-1": 69.7,
    ...
    links: {
      docs: "https://platform.apodex.ai/docs/models",
      announcement:
        "https://www.prnewswire.com/news-releases/apodex-1-1-moves-ai-beyond-deep-research-to-verifiable-execution-302866271.html",
    },
    summary:
      "Apodex's 397B flagship reasoning model for long-horizon professional and scientific work (research, financial analysis, legal review, scientific experiments), built around its TRACES process-verification system and FrontierAgent execution framework; reasons by default and is accessed via API rather than as open weights.",
  },
  {
    ...
    maxOutput: 32_768,
    modalities: { input: ["text"], output: ["text"] },
    pricing: { provider: "Apodex", inputPer1M: 0.1, outputPer1M: 1 },
    benchmarks: {},
    links: {
      modelCard: "https://huggingface.co/apodex/Apodex-1.1-mini",
      docs: "https://platform.apodex.ai/docs/models",
    },
    summary:
      "Open-weight (Apache 2.0) 35B lower-latency sibling of Apodex 1.1, tuned for high-volume classification, extraction, and drafting work within the same reasoning-by-default execution framework.",
  },
];
